...
//     return (
//         <div id='movie-card' className="group bg-zinc-900 col-span relative h-[12vw]">
//             <img 
//                 id='movie-card-thumbnail'
...
//                 alt="Thumbnail"
//             />
//             <div id='movie-card-detail' className="opacity-0 absolute top-0 transition duration-200 z-10 invisible sm:visible delay-300 w-full scale-0 group-hover:scale-110 group-hover:-translate-y-[6vw] group-hover:translate-x-[2vw] group-hover:opacity-100">
//                 <img 
//                     className="cursor-pointer object-cover transition duration shadow-xl rounded-t-md w-full h-[12vw]"
//                     src={data.thumbnailUrl} 
//                     alt="Thumbnail"
...
//                         </div>
//                         <FavoriteButton movieId={data?.id}/>
//                         <div onClick={() => openModal(data?.id)} className="cursor-pointer m1-auto group/item w-6 h-6 lg:w-10 lg:h-10 border-white border-2 rounded-full flex justify-center items-center transition hover:border-neutral-300">
//                             <MdMoreHoriz size={25} className="text-white group-hover/item:text-neutral-300"/>
//                         </div>
//                     </div>
//                     <p className="text-green-400 font-semibold mt-4">
